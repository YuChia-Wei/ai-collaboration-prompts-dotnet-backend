...
This agent is intentionally manually selected. Stop without writing if the source is not finalized, the paths are ambiguous, or the configured lower-cost model is unavailable for the current Copilot plan or client.
