...
Typical inventory commands include:

- `rg --files`
- `Get-ChildItem -Recurse -Filter *.sln`
- `Get-ChildItem -Recurse -Filter *.csproj`
- `dotnet sln list`
- `rg -n "<TargetFramework>|<PackageReference" -g "*.csproj" -g "Directory.Packages.props"`

The exact command set can vary by environment.
What matters is capturing file-backed evidence before rewriting docs.
