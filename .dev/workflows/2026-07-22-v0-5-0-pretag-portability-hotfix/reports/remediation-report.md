...
- Completed scope: incident registered; bounded decoder fix and two regression
  scenarios implemented.
- Validation summary: 6 focused pre-tag tests, 15 adjacent release-state tests,
...
| --- | --- | --- | --- | --- | --- | --- |
| `PTP-001` | HIGH / P0 | `partially-resolved` | pre-tag script and tests | 27 focused/adjacent tests plus workflow and AI-context validation pass | pending | merged-main pre-tag and hosted evidence remain pending |
