...
- Git state: checkpoints through TRUTH-002 metadata `7edee7a` are pushed; EXAMPLE-002 implementation is committed as `16595ea` and pending publication with checkpoint metadata.
