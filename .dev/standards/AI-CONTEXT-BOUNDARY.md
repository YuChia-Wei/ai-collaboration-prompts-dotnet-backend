...
| Project truth | Requirements, specs, operations, architecture facts, workflows, and decisions for this repository. | `.dev/` |
...
- Put project requirements, specs, operations truth, workflow artifacts, and architecture facts under `.dev/`.
...
3. Does it describe this repo's actual domains, services, queues, specs, operations, or workflow state?
   - Yes: use `.dev/`.
