...
| `v0.5.0` | `in_progress` | yes | `PKG-003`, `SAG-001`, `TOOL-001`, and `LANG-001` are complete; `GOV-001`, `CAP-001`, and `VAL-001` are disposed. Complete `ENF-001`, `HANDOFF-001`, and `REL-001` as the remaining release blockers. | Consume the verified package, adapter, offline dependency, portability, and hybrid language gates in enforcement, handoff, and release mechanics. | [`2026-07-21-v0-5-0-development`](../workflows/2026-07-21-v0-5-0-development/workflow.yaml) |
