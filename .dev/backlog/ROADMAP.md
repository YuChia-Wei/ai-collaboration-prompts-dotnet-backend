...
| `v0.4.2` | `ready_for_workflow` | yes | Deliver the complete content and wrapper correctness set originally assigned to v0.4.1, including context-translator routing, without broadening into new runtime-adapter semantics. | Create a fresh remediation workflow from the retained post-v0.4.0 improvement plan; do not silently broaden into v0.5.0 schema or adapter work. | not created |
...
Create a fresh v0.4.2 remediation workflow for the complete deferred correction
set. Keep v0.4.0 consumers on their current version until v0.5.0 unless they
explicitly choose a manual reconciliation; `PKG-003` must prove their direct
v0.5.0 path.
